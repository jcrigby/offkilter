...
- [x] Language-model access: `ok-mcp` (MCP over stdio) with apply / report / screenshot / export (STL, STEP, DXF views) tools against a running server or a local file; `POST /api/docs/:id/ops` and `GET /api/docs/:id/report` for scripts
